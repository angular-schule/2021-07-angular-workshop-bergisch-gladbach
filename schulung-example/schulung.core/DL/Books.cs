...
namespace Schulung.Core
{
  /// <summary>
  /// 
  /// Kapselt den Datenzugriff auf eine Zeile der Tabelle Book
  /// </summary>
  ...
  public class Books: ON.Data.Common.AbstractDataLayerObject, System.Runtime.Serialization.ISerializable, System.Xml.Serialization.IXmlSerializable,IChangeable,ICreateable
  {
    /// <summary>
    ...
    /// </summary>
    public static Books Dummy { get; } = new Books();
    /// <summary>
    ...
    public static DataLayerObjectCollection<Books> LoadList(string sqlWhere, string join, string order, OnSqlParameterCollection onSqlparameters, SqlTransaction trans, SqlConnection con, string connectionString, IUser owner, int top = -1, ActivationDelegateCollection delegates = null, Languages lang = Languages.None, IExternalDataSource externalDataSource = null, IDataLayerCache cache = null)
    {
      return LoadList<Books>(sqlWhere, join, order, onSqlparameters, trans, con, connectionString, owner, top, delegates, lang, externalDataSource ?? Dummy.ExternalDataSource, Dummy, cache);
    }
    ...
    /// <returns></returns>
    public static DataLayerObjectCollection<Books> LoadList(string where, OnSqlParameterCollection onSqlparameters, string ConnectionString, IUser Owner, ActivationDelegateCollection delegates = null, Languages Language = Languages.None)
    {
      return LoadList<Books>(where, null, null, onSqlparameters, null, null, ConnectionString, Owner, -1, delegates, Language, Dummy.ExternalDataSource, Dummy, null);
    }
    ...
    /// <returns>geladene objekte</returns>
    public static DataLayerObjectCollection<Books> LoadSortedPage(string filter, string sort, string connectionString, IUser owner, string join, int pageSize, int pageIndex, SqlConnection con, SqlTransaction trans, ResultCount count, ActivationDelegateCollection delegates, string fieldsWithId, string tablename, string IdDbName, Languages lang = Languages.None, IExternalDataSource externalDataSource = null, OnSqlParameterCollection sqlparams = null)
    {
      return LoadSortedPage<Books>(filter, sort, connectionString, owner, join, pageSize, pageIndex, con, trans, count, delegates, fieldsWithId, tablename, IdDbName, lang, externalDataSource ?? Dummy.ExternalDataSource, sqlparams);
    }
    ...
    {
      return LoadSortedPage<Books>(filter, sort, connectionString, owner, join, pageSize, pageIndex, null, null, count, delegates, Dummy.FIELDSWITHID,  Dummy.FullTABLENAME, Dummy.IdDbName, lang, externalDataSource ?? Dummy.ExternalDataSource, sqlparams);
    }
    ...
    public static void Mix(DataLayerObjectCollection<Books> oldList, IEnumerable newList)
    {
      Mix<Books>(oldList, newList);
    }
    /// <summary>
    ...
    /// <param name="externalDataSource">Externe Datenquelle</param>
    /// <param name="cache"></param>
    public static Books Get(IPrimaryKey id, SqlTransaction trans, SqlConnection con, string cs, IUser owner, ActivationDelegateCollection delegates = null, Languages lang = Languages.None, IExternalDataSource externalDataSource = null, IDataLayerCache cache = null)
    {
      return Get<Books>(id, trans, con, cs, owner, delegates, lang, externalDataSource ?? Dummy.ExternalDataSource, cache);
    }
    ...
    /// <param name="cs">Connection string</param>
    /// <param name="owner">Besitzer (für logging)</param>
    public static Books Get(IPrimaryKey id, string cs, IUser owner)
    {
      return Get<Books>(id, null, null, cs, owner, null, Languages.None, Dummy.ExternalDataSource, null);
    }
    ...
    public static Books Get(string sqlWhere, OnSqlParameterCollection onSqlparameters, SqlTransaction trans, SqlConnection con, string cs, IUser owner, ActivationDelegateCollection delegates = null, Languages lang = Languages.None, IExternalDataSource externalDataSource = null, IDataLayerCache cache = null)
    {
      return Get<Books>(sqlWhere, onSqlparameters, trans, con, cs, owner, delegates, lang, externalDataSource ?? Dummy.ExternalDataSource, cache);
    }
    ...
    /// <param name="cs">Connection string</param>
    /// <param name="owner">Besitzer (für logging)</param>
    public static Books Get(string sqlWhere, OnSqlParameterCollection onSqlparameters, string cs, IUser owner)
    {
      return Get<Books>(sqlWhere, onSqlparameters, null, null, cs, owner, null, Languages.None, Dummy.ExternalDataSource );
    }
    ...
    public static readonly ActivationDelegate authorsRollDelegate = new ActivationDelegate(authorsRollDelegateFunction);


    private Authors authorsRoll;
    /// <summary>
    /// 
    /// liefert / setzt AuthorsRoll
    /// </summary>
    ...
    public Authors AuthorsRoll
    {
      get
      {
        return this.authorsRoll;
      }

      set
      {
         bool realChange = false;
        this.authorsRoll = value;
        if (this.authorsRoll != null && ((IntPrimaryKey)authorId != (IntPrimaryKey)this.authorsRoll.Id || this.authorsRoll.Id.IsNew))
        {
          IsChanged = true;
          realChange = true;
          authorId = (IntPrimaryKey)this.authorsRoll.Id;
        }
        else if (this.authorsRoll == null)
        {
          IsChanged = true;
          realChange = true;
          authorId = (IntPrimaryKey)Schulung.Core.Authors.Dummy.Id.Empty;
        }
        if (realChange)
        {
          if ((CheckRight(nameof(AuthorsRoll)) & ON.Data.Common.Rights.Write) == 0)
          {
            throw new SecurityException("kein schreibender Zugriff auf " + nameof(AuthorsRoll) + " erlaubt");
          }
        }
      }
    }
    ...
    /// (r1)
    /// <summary>
    /// automatisches nachladen von AuthorsRoll
    /// </summary>
    ...
    public static void authorsRollDelegateFunction(ON.Data.Common.AbstractDataLayerObject data, ActivationDelegateCollection delegates)
    {
      var list = data as DatalayerCollectionWrapper;
      if (list != null)
      {
        if (list.List is DataLayerObjectCollection<Books> innerList)
        {
          MassActivateAuthorsRoll(innerList, null, delegates);
        }
      }
      else
      {
        Books obj = data as Books;
        obj?.activateAuthorsRoll(delegates);
      }
    }
    ...
    /// <summary>
    /// (r2)
    /// nachladen von AuthorsRoll
    /// </summary>
    public void activateAuthorsRoll()
    {
      activateAuthorsRoll(EMPTY_DELEGATE_LIST);
    }
    ...
    public void activateAuthorsRoll(ActivationDelegateCollection delegates)
    {
      if (!AuthorId.IsNew && this.authorsRoll == null)
      {
        this.authorsRoll = ON.Data.Common.AbstractDataLayerObject.Get<Schulung.Core.Authors>(AuthorId, null, null, ConnectionString, Owner, delegates, Language, Schulung.Core.Authors.Dummy.ExternalDataSource, null);
      }
    }
    ...
    /// <param name="trans">aktuelle Transaktion</param>
    /// <param name="con">aktuelle Datenbankverbindung</param>
    public void activateAuthorsRoll(SqlTransaction trans, SqlConnection con)
    {
      activateAuthorsRoll(trans, con, EMPTY_DELEGATE_LIST);
    }
    ...
    /// <param name="delegates">nachzuaktivieren ...</param>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("ONCodeAnalyse", "ON1057:NullTestDL"), System.Diagnostics.CodeAnalysis.SuppressMessage("ONCodeAnalyse", "ON1013:privateMemberpublicProperty", Justification = "wollen kein changed bekommen")]
    public void activateAuthorsRoll(SqlTransaction trans, SqlConnection con, ActivationDelegateCollection delegates)
    {
      if (!AuthorId.IsNew && this.authorsRoll == null)
      {
        authorsRoll = ON.Data.Common.AbstractDataLayerObject.Get<Schulung.Core.Authors>(AuthorId, trans, con, ConnectionString, Owner, delegates, Language, Schulung.Core.Authors.Dummy.ExternalDataSource, null);
      }
    }
    ...
    /// <summary>
    /// gleichzeitiges Nachladen aller AuthorsRoll
    /// </summary>
    ...
    public static DataLayerObjectCollection<Authors> MassActivateAuthorsRoll(DataLayerObjectCollection<Books> list, Func<string, OnSqlParameterCollection, string, IUser, ActivationDelegateCollection, Languages, DataLayerObjectCollection<Authors>> loader = null, ActivationDelegateCollection delegates = null)
    {
      if (list == null || list.Count == 0)
      {
        return new DataLayerObjectCollection<Authors>(0);
      }
      if (loader == null) //default
      {
        loader = Schulung.Core.Authors.LoadList;
      }

      StringBuilder ids = new StringBuilder(list.Count * 7);
      foreach (var m in list)
      {
        if (m.AuthorsRoll == null && !m.AuthorId.IsNew)
        {
      ...
      var lookUpList = new Dictionary<IPrimaryKey, Authors>(sortedList.Count * 4);
    ...
    m.AuthorsRoll = lookUpList[m.AuthorId];
        }
      }
    ...
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("ONCodeAnalyse", "ON1057:NullTestDL")]
    public void createAuthorsRoll()
    {
      if (AuthorsRoll == null)
      {
        AuthorsRoll = Schulung.Core.Authors.Get(Dummy.Id.Empty, ConnectionString, Owner);
      }
    }
    ...
    private const string fulltablename = @"[dbo].[Book]"; //HINWEIS: Wenn Multilanguagefelder oder AdditionalFields in anderer DB liegen, dann läuft das nicht!
    private const string sqlschema = "dbo";

    private const string fieldsWId = @"[Book].[AuthorId],[Book].[ChangedAt],[Book].[ChangedBy],[Book].[CreatedAt],[Book].[CreatedBy],[Book].[Description],[Book].[Isbn],[Book].[Title],[Book].[Id]";
    private const string valuesWId = @"@AuthorId,@ChangedAt,@ChangedBy,@CreatedAt,@CreatedBy,@Description,@Isbn,@Title,@Id";
    private const string fieldsWOId = @"[Book].[AuthorId],[Book].[ChangedAt],[Book].[ChangedBy],[Book].[CreatedAt],[Book].[CreatedBy],[Book].[Description],[Book].[Isbn],[Book].[Title]";
    private const string valuesWOId = @"@AuthorId,@ChangedAt,@ChangedBy,@CreatedAt,@CreatedBy,@Description,@Isbn,@Title";
...
#pragma warning restore CA2245 // Do not assign a property to itself.
    ...
    /// <summary>
    /// (4)
    /// Erzeugt ein neues Books Objekt aus vorhandenem
    ...
    public Books(Books old): base(old)
    {
      if (old == null)
      {
      ...
      id = old.id;
init();
      if (old.authorsRoll != null)
      {
        authorsRoll = old.authorsRoll;
      }
...
EnableLogging = false;
    ...
    public override void FillFromRow(IDataRecord row, SqlConnection con, SqlTransaction trans)
    {
      ...
      this.title = CommonUtilities.GetValue(this.title, row,7);
			this.id = (IntPrimaryKey)CommonUtilities.GetValue(this.id, row,8);
...
//        LogManager.LogDebug("DataLayer", "getXML: " + GetType().FullName + "StackTrace: " + ON.GeneralUtilities.StackTrace, null);
      ...
      if(includeSubobjects)
      {
        ...
        if((CheckRight(nameof(AuthorsRoll)) & ON.Data.Common.Rights.Read) != 0)
        {
          if (authorsRoll != null)
          {
            sb.AppendXmlNode(nameof(authorsRoll), (sbInner) => authorsRoll.GetXml(true, false, sbInner));
          }
        }
    ...
    protected override void SaveRoles(SqlConnection con, SqlTransaction trans)
    {
      ...
      if (authorsRoll != null)
      {
        authorsRoll.Save(con, trans);

authorId = (IntPrimaryKey)authorsRoll.Id;
...
#pragma warning disable ON1057 // NullTestDL
      if (authorsRoll != null && authorsRoll.DeleteMark)
#pragma warning restore ON1057 // NullTestDL
    ...
    public static int Count(string sqlWhere, OnSqlParameterCollection onSqlparameters, string connectionString, Languages lang, IExternalDataSource externalDataSource)
    {
      ...
      else
      {
        if (cache != null)
        {
          var count = cache.getResultCount<Books>(Dummy, sqlWhere, onSqlparameters);
        ...
        if (cache != null)
        {
          ...
          cache.putResultCount<Books>(Dummy, sqlWhere, onSqlparameters, rc);
        }
      }
...
#pragma warning restore ON1091 // UseNameOf
    ...
    public override void GetObjectData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    {
      ...
      info.AddValue(nameof(authorsRoll), this.authorsRoll);
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506: AvoidExcessiveClassCoupling")]
[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode")]
    protected Books(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base(info, context)
    {
      if (info == null)
      {
        throw new ArgumentNullException(nameof(info));
      ...
      this.authorsRoll = (Authors)info.GetValue(nameof(authorsRoll), typeof(Schulung.Core.Authors));
   init();
    }
    ...
    public override void ReadXml(System.Xml.XmlReader reader)
    {
      ...
      node = doc.SelectSingleNode("*/authorsRoll");
      if (node != null)
      {
        ...
        try
        {
          ...
          strreader = null;
          Schulung.Core.Authors obj = Schulung.Core.Authors.Get(Schulung.Core.Authors.Dummy.Id, ConnectionString, Owner);//yyy
  ...
  propertyName = propertyName.Replace("[", string.Empty).Replace("]", string.Empty);
      ...
      else if (propertyName.Equals("Book.authorId", StringComparison.OrdinalIgnoreCase))
      {
      ...
      else if (propertyName.Equals("Book.changedAt", StringComparison.OrdinalIgnoreCase))
      {
        return "[Book].[ChangedAt]";
      }
      else if (propertyName.Equals(nameof(changedBy), StringComparison.OrdinalIgnoreCase))
      {
        return "[ChangedBy]";
      }
      else if (propertyName.Equals("Book.changedBy", StringComparison.OrdinalIgnoreCase))
      {
        return "[Book].[ChangedBy]";
      }
      else if (propertyName.Equals(nameof(createdAt), StringComparison.OrdinalIgnoreCase))
      {
        return "[CreatedAt]";
      }
      else if (propertyName.Equals("Book.createdAt", StringComparison.OrdinalIgnoreCase))
      {
      ...
      else if (propertyName.Equals("Book.createdBy", StringComparison.OrdinalIgnoreCase))
      {
      ...
      else if (propertyName.Equals("Book.description", StringComparison.OrdinalIgnoreCase))
      {
      ...
      else if (propertyName.Equals("Book.isbn", StringComparison.OrdinalIgnoreCase))
      {
        return "[Book].[Isbn]";
      }
      ...
      else if (propertyName.Equals("Book.title", StringComparison.OrdinalIgnoreCase))
      {
        return "[Book].[Title]";
      }
      ...
      else if (propertyName.Equals("Book.id", StringComparison.OrdinalIgnoreCase))
      {
        return "[Book].[Id]";
      }
      else
    ...
    public override ON.Data.Common.AbstractDataLayerObject GetOldVersion()
    {
      ...
      string sqlWhere = getPKWhere<Books>(Id, param, Language);
      return Get<Books>(sqlWhere, param, null, null, ConnectionString, Owner, null, Language, null, null,false);
    }
    ...
    {
      StringBuilder sb = new StringBuilder("<data>", 4500);
      ...
      else //diff xml
      {
        ...
        Books oldVersion = ON.Data.Common.AbstractDataLayerObject.Get<Books>(Id, trans, con, ConnectionString, Owner, null, Language, ExternalDataSource, null);
      ...
      sb.Append("</data>");
      LogbuchEntry entry = new LogbuchEntry(Owner.LoggingIdentifier, null, "none", "Schulung.Core.Books", DateTime.UtcNow, sb.ToString(), Id.ToString(), action);
    ...
    public void GetDiffXml(StringBuilder sb, Books oldVersion, bool removeHtml = false, bool includeRolesAndCollections = false)
    {
    ...
    public void GetDiffXml(StringBuilder sb, Books oldVersion, bool removeHtml, bool includeRolesAndCollections, SqlTransaction trans, SqlConnection con)
    {
    ...
    public override void GetDiffXml(StringBuilder sb, ON.Data.Common.AbstractDataLayerObject oldVersion, bool removeHtml, bool includeRolesAndCollections, SqlTransaction trans, SqlConnection con)
      {
         GetDiffXml(sb, (Books)oldVersion, removeHtml, includeRolesAndCollections, trans, con);
      }
    ...
    public override void GetDiffXml(StringBuilder sb, ON.Data.Common.AbstractDataLayerObject oldVersion, bool removeHtml, bool includeRoles, bool includeCollections, SqlTransaction trans, SqlConnection con)
      {
        GetDiffXml(sb,  (Books) oldVersion, removeHtml, includeRoles, includeCollections, trans, con);
      }
...
#pragma warning disable IDE0060 // Remove unused parameter
    public void GetDiffXml(StringBuilder sb, Books oldVersion, bool removeHtml, bool includeRoles, bool includeCollections, SqlTransaction trans, SqlConnection con)
#pragma warning restore IDE0060 // Remove unused parameter
    {
      ...
      if (oldVersion.Description != this.Description)
      {
        ...
        if((CheckRight(nameof(Description)) & ON.Data.Common.Rights.Read) != 0)
        {
          ...
          {
            sb.AppendXmlNode(nameof(description), ON.Text.TextUtilities.GetDefaultFormated(oldVersion.Description,Language).ReplaceEntities());
          }
        }
        sb.Append("</old><new>");
...
activateAuthorsRoll(trans, con);
  oldVersion.activateAuthorsRoll(trans, con);

  if(oldVersion.AuthorsRoll != null)
  {
     oldvalue = oldVersion.AuthorsRoll.FachlicherPk;
  }

  if(AuthorsRoll != null)
  {
     newvalue = AuthorsRoll.FachlicherPk;
  }

  if (!oldvalue.Equals(newvalue))
  {
    sb.Append(@"<role roleId=""AuthorId"" field=""Authors"" label="""">");
